...
{
    public class PiMembershipFunctionTests
    {
        ...
        [TestCase(0.2, ExpectedResult = 0.92)]
        [TestCase(0.8, ExpectedResult = 0.08)]
        ...
        [TestCase(0.5, ExpectedResult = 0.5)]
        [TestCase(0.2, ExpectedResult = 0.08)]
        [TestCase(0.8, ExpectedResult = 0.92)]
        ...
        private static PiMembershipFunction Create() => new();
    }
}